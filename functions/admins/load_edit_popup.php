...
<div class="form-group">
	...
	<div class="row row-sm">
		<div class="col-md-6" style="margin-bottom:10px">
			<label class="ckbox"><input type="checkbox" name="editRoles[]" <?php echo in_array('coffeemanagement', $roles) ? 'checked' : ''; ?> value="coffeemanagement"><span><b>Coffee Management</b></span></label>
		</div>
		<div class="col-md-6" style="margin-bottom:10px">
		...
		<div class="col-md-6" style="margin-bottom:10px">
			<label class="ckbox"><input type="checkbox" name="editRoles[]" <?php echo in_array('ordermanagement', $roles) ? 'checked' : ''; ?> value="ordermanagement"><span><b>Order Management</b></span></label>
		</div>
		<div class="col-md-6" style="margin-bottom:10px">
