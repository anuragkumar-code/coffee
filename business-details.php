			...
			<div class="d-flex my-auto">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="business-management.php">Business</a></li>
							...
							<div class="main-profile-overview">
								<div class="d-flex">
									<div class="main-img-user profile-user">
										<img alt="" src="assets/img/users/sample.png">
									</div>
									<div class="d-flex justify-content-between mg-b-20 mt-5 ms-3">
			    						<div>
											<h5 class="main-profile-name"><?php echo $row['name']; ?></h5>
											<p class="main-profile-name-text"><b>Partner Since</b> <?php echo date('d/m/Y', strtotime($row['created_at'])); ?></p>
										</div>
									</div>
								</div>
